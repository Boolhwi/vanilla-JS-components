...
drag_and_drop.innerHTML = "<div id=drop_box1 ondrop=drop(event) ondragover=allowDrop(event)>Drop_box1</div><div id=drop_box2 ondrop=drop(event) ondragover=allowDrop(event)>Drop_box2</div><br><div id=dd_contents draggable=true ondragstart=drag(event)>contents...</div>";
...
var dd_contents = document.getElementById("dd_contents");
dd_contents.style.cssText = "width: 160px;background-color: #555; color: #fff;text-align: center;border-radius: 6px;padding: 8px 0; margin-top:10px";
